            ...
            <div className="flex xl:flex-row flex-col justify-between items-start pt-16">
              <div className="flex justify-center items-center xl:w-7/12">
                <h1 className="xl:text-5xl text-4xl font-extrabold xl:leading-tight text-white xl:mt-8">
                  System architecture and front-end development
                </h1>
              </div>
              <div className="w-full xl:-mr-8 xl:w-3/4 flex justify-end items-end xl:mt-6 mt-10 ">
                <img
                  className="w-full"
                  src={
                    'https://cdn.tuk.dev/assets/templates/portfolio/Dashboard.png'
                  }
                  alt="Dashboard"
                />
              </div>
              ...
              <div className="flex justify-start items-start flex-col  ">
                ...
                <div className="mt-6">
                  <p className="text-base leading-normal text-gray-400">
                    Front-end Architecture is a collection of tools and
                    processes that aims to improve the quality of our front-end
                    code while creating a more efficient and sustainable
                    workflow. A Front-end developer's audience is the website
                    user, a Front-end Architect's audience is the developer
                    themselves.
                  </p>
                </div>
                <div className="mt-8">
